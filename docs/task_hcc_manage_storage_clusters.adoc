...
C'est ça link:concept_hci_storage_maintenance_mode.html["mode maintenance"] les options de fonction vous permettent de ,activer et ,désactiver mode maintenance d'un nœud de cluster de stockage.
